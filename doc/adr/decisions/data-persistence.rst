...
**Justification**:
DynamoDB is the only option that fully aligns with our **Serverless First** strategy (:doc:`architecture-style`).
...
We accept the trade-off of "Eventual Consistency" (see :doc:`../../arch/views/cross-cutting-concepts` [CC-DAT-002]) and lack of joins in exchange for predictable performance and operational simplicity.
