...
**Justification**:
DynamoDB is the only option that fully aligns with our **Serverless First** strategy ([ADR-ARCH-001 (Adopt Microservices Architecture)](architecture-style.md#ADR-ARCH-001)).
...
We accept the trade-off of "Eventual Consistency" (see [CC-DAT-002 (Rule [CC-DAT-002])](../../arch/views/cross-cutting-concepts.md#CC-DAT-002)) and lack of joins in exchange for predictable performance and operational simplicity.
