...
**Scenario**:
1. The :ref:`Managed Application <TERM-APP-TARGET>` requests flags from the :ref:`Control Plane <TERM-SYS-CP>` (API).
...
2. The :ref:`Managed Application <TERM-APP-TARGET>` sends event data to the :ref:`Control Plane <TERM-SYS-CP>` API.
...
2. The :ref:`Managed Application <TERM-APP-TARGET>` streams/sends the log to the :ref:`Control Plane <TERM-SYS-CP>` API.
