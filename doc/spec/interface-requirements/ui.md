...
**User**: [ACT-OPS (Platform Operator)](../actors/platform-operator.md#ACT-OPS)
**Description**:
...
**User**: [ACT-USER (Tenant User)](../actors/tenant-user.md#ACT-USER) (Owner, Admin)
**Description**:
...
**User**: [ACT-AUDIT (Auditor)](../actors/auditor.md#ACT-AUDIT)
**Description**:
...
**User**: [ACT-USER (Tenant User)](../actors/tenant-user.md#ACT-USER), [ACT-OPS (Platform Operator)](../actors/platform-operator.md#ACT-OPS), [ACT-AUDIT (Auditor)](../actors/auditor.md#ACT-AUDIT)
**Description**:
