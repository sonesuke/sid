...
<!-- list-table not converted -->
   ...
   * - **[DEP-ENV-001] Development**
     ...
     - *   [CC-DEV-001](cross-cutting-concepts.md#CC-DEV-001)
   * - **[DEP-ENV-002] Staging**
     - **Purpose**: Pre-production verification (E2E, Load Tests).
     - *   [CC-OPS-002](cross-cutting-concepts.md#CC-OPS-002)
   * - **[DEP-ENV-003] Production**
     - **Purpose**: Live traffic. High Availability.
     - *   [NFR-OPS-001](../../spec/non-functional-requirements/availability.md#NFR-OPS-001)
...
*   **[DEP-OPS-001] Blue-Green Switchover**:
    ...
    *   **Decision**: [../../adr/decisions/deployment-strategy](../../adr/decisions/deployment-strategy.md)
    *   **Principles**: [CC-OPS-001](cross-cutting-concepts.md#CC-OPS-001) (Reversibility), [CC-OPS-003](#CC-OPS-003) (DB Compatibility).
